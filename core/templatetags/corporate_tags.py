...
from corporate.blog.models import BlogPage
from corporate.core.models import Advert, JobIndexPage, MainMenu
from corporate.core.utils import roundrobin
from corporate.people.models import PersonPage
from corporate.work.models import WorkPage
...
@register.inclusion_tag(
    "corporate/tags/homepage_people_listing.html", takes_context=True
)
...
@register.inclusion_tag("corporate/tags/homepage_blog_listing.html", takes_context=True)
...
@register.inclusion_tag("corporate/tags/homepage_work_listing.html", takes_context=True)
...
@register.inclusion_tag("corporate/tags/homepage_job_listing.html", takes_context=True)
...
# Advert snippets
@register.inclusion_tag("corporate/tags/adverts.html", takes_context=True)
def adverts(context):
    return {
...
@register.inclusion_tag("corporate/tags/person_blog_listing.html", takes_context=True)
...
@register.inclusion_tag("corporate/tags/work_and_blog_listing.html", takes_context=True)
